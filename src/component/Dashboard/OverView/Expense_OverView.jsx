    ...
    <div className="flex">
      <div>
        <div className="flex gap-3 items-center justify-center ml-2  ">
          <div>
            <div className=" mt-3 mb-3 ">
              <h1 className="text-2xl text-[#144c90] font-mulish font-bold">Hi,bwiza linda</h1>
            ...
            <div className="flex gap-3 ">
              <div className="flex flex-wrap gap-3">
                <div className="w-60   h-20 rounded-md flex  gap-1  bg-slate-50 shadow-sm">
                  <div className=" text-xl font-mulish font-bold m-3 bg-[#f1f1f1] text-[#a6f9bd] p-4 rounded-full">
                    <IoStatsChartSharp />
                  </div>
                  <div className="m-3">
                    <p className="font-mulish">Earning</p>
                    <p className="font-mulish font-bold">20MRwf</p>
                  </div>
                </div>
                <div className="w-60  h-20 rounded-md flex  gap-1  bg-slate-50 shadow-sm">
                  <div className=" text-xl font-mulish font-bold m-3 bg-[#f1f1f1] text-[#a6f9bd] p-4 rounded-full">
                  ...
                  <div className="m-3">
                    <p className="font-mulish">Spend this month</p>
                    <p className=" font-mulish font-bold">20MRwf</p>
                  </div>
                </div>
                <div className="w-60  h-20 rounded-md flex  gap-1  bg-slate-50 shadow-sm">
                  ...
                  <div className="m-3">
                    <p className="font-mulish">Salary</p>
                    <p className=" font-mulish font-bold">20MRwf</p>
                  </div>
                </div>
                <div className="w-60   h-20 rounded-md flex  gap-1  bg-slate-50 shadow-sm">
                  ...
                  <div className="m-3">
                    <p className="font-mulish">Other Income</p>
                    <p className=" font-mulish font-bold">20MRwf</p>
                  </div>
                </div>
              </div>
        ...
        <div className="flex mt-3 ml-1 gap-3">
          <div className="w-[655px] rounded-md font-mulish  bg-slate-50 shadow-sm">
            <h1>Time and Expenses Bar Chart</h1>
            <BarCharts data={data} />
          </div>
          <div className="flex flex-col gap-3">
            <div className="text-2xl font-mulish font-bold ">Latest Budget</div>
            <div className="w-80 h-32 rounded-md  bg-slate-50 shadow-sm">
              <div className="m-8">
                <div className="flex justify-between font-mulish font-bold">
                  <p>food and drinks</p>
                  <p>10MRwf</p>
                </div>
                <div>
