...
const Header = () => {
  return (
    <div>
      <div className="flex justify-between  items-center  z-30  px-8 mt-3 text-[#000300] top-0  mb-0 pb-0">
        
        <div className="font-mulish">
         
          <p className="text-3xl font-mulish text-[#144c90] font-bold">Main DashBoard</p>
        </div>
